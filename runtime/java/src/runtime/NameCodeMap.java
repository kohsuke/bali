...
final class NameCodeMap
{
    ...
    /**
     * Find the names that match the given element and adds them into the collection
     */
    public void find( Transition.Element et, Collection tokens ) {
        for( int i=table.length-1; i>=0; i-- ) {
            for( Entry e = table[i]; e!=null; e=e.next ) {
                if(et.accepts(e.nameCode))
