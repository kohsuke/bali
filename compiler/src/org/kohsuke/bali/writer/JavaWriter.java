...
public class JavaWriter extends StringBasedEncoder {
    public JavaWriter( String packageName, String className, File outDir, boolean jaxp, boolean jarv ) throws IOException {
    ...
    private final boolean jaxp;
    private final boolean jarv;
    ...
    protected void write(
        ...
        copy("BaliSchema.java");
        copy("State.java");
        copy("StateFactory.java");
        copy("Transition.java");
        copy("Validatelet.java");
        if(jaxp) {
            copy("JAXPSchemaImpl.java");
            copy("JAXPValidatorHandlerImpl.java");
            copy("JAXPValidatorImpl.java");
        }
        if(jarv) {
            copy("JARVSchemaImpl.java");
            copy("JARVVerifierHandlerImpl.java");
            copy("JARVVerifierImpl.java");
        }
    }
